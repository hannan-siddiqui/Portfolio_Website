...
const FirstPage = () => {
  ...
  return (
    <div className="relative py-10 bg-custom overflow-hidden md:h-screen">
      ...
      <div className=" absolute w-[100%] h-[100%] opacity-15">
      ...
      <div className="relative mt-20 md:mt-52 md:flex justify-evenly md:gap-5 ">
        ...
        <div className=" flex flex-col">
          ...
          <div className=" rounded-xl flex flex-col justify-center firstpage_i_am_coder_line mx-8 p-4 md:p-16">
            ...
            <div 
             className="  w-[290px] md:h-[200px]  overflow-hidden md:w-[550px] ml-4 mt-2 md:mt-4  font-semibold text-lg md:text-3xl text-neutral-300">
...
{/* social links */}
          ...
          className="border border-neutral-500 w-[370px] md:w-[694px] rounded-2xl  md:mt-4 mt-8 mx-5 md:ml-20 md:mx-0  flex justify-evenly items-center text-5xl py-6  overflow-hidden">
