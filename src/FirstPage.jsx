      ...
      <div className=" relative mt-20 md:mt-52 md:flex justify-evenly md:gap-5 ">
        ...
        <div className=" flex justify-center items-center">
          ...
          <div className="r um border-[2px] hover:border-black border-red-500 flex justify-center items-center flex-col pb-10 w-[380px]  md:w-[700px]">
            ...
            <div className="md:mr-36 rounded-xl w-[90%] md:w-[550px] flex flex-col justify-center firstpage_i_am_coder_line mx-8 p-4 md:p-16">
              ...
              <div className="n1 w-[320px] md:h-[200px] overflow-hidden md:w-[550px] h-[180px] mt-2 md:mt-4 p-2 text-xl font-bold md:text-3xl text-[#252323] place-content-center text-center border hover:border-black border-red-500">
            ...
            {/* social links */}
            <div className="border n1   w-[320px] md:w-[550px]   md:mt-4 mt-8     flex justify-evenly items-center text-3xl md:text-7xl md:p-6 p-4 overflow-hidden  hover:border-black border-red-500">
        ...
        <div className="card3d shadow-2xl shadow-zinc-400 hover:shadow-white border-[2px] hover:border-black border-red-500 sociallinkdiv mx-10 md:mx-0 md:p-0 mt-16 mb-10 md:mt-0 sm:w-[350px] md:w-[410px]">
          <img className=" aspect-[3/4]  object-cover" src={hannanImage} alt="404" />
        </div>
