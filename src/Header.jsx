...
const Header = ({
  ...
  return (
    <div className="flex justify-center ">
      <div className="mt-3 w-[90%] n2  md:pl-10 fixed z-10   py-4 md:py-8 flex md:flex-row flex-col  md:justify-start justify-evenly items-center">
        <div className="flex justify-evenly items-center ">
          ...
          <div className="lg:hidden md:hidden ml-12">
            <button
              onClick={toggleItems}
              className="text-xl text-white font-semibold px-4 py-2 bg-gray-800 rounded-lg"
            >
